...
Function Invoke-GetIdServerTokenTask {
    ...
    Write-Host "Get Token From Sitecore.IdentityServer - Uri: $UrlIdentityServerGetToken Body: $body " -ForegroundColor Green
...
Function Invoke-InitializeCommerceServicesTask {
    ...
    foreach ($env in $Environments) {
        ...
        Write-Host "Initializing $($env) using $($initializeUrl)" -ForegroundColor Yellow
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUioYTq1WPGJh4WebZMAu6raqs
# XVugghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPx76RKTFuS1YfM5PB3LCwcj
# v7PcMA0GCSqGSIb3DQEBAQUABIIBABCM+f7rLp6PfgYMNSmwV5eINs6ML7/5KWbb
# U26cVwTrKpdZOO0K2JtjXVB6vS0jTZwbWf4ga6c0Tcxxq4Mdps4eQ/Tnsnd1Q8LF
# fWpYd4Gidtscf8NqBBreXYerrqlNrXmKT99wezyDoMj18rERrwf/BcsRdivKc5tC
# SQS9Eyb0T+TYcS9VMK/dlZPScFgI/xsL2pJVpzS8+ocpMnyuK34M+4RDUFlJCxCa
# qrbx9JT+8wHF7if11YKR5cD4BSHfnJDyAjmqQ1jc00XJjb9HcWseQ2AAnte5jDQj
# SCpKYdb0uzyX575CpkNJFe1EqNdxs4aixJUY6JCWk1EPEcKd0QOhggILMIICBwYJ
...
# MTgwMzEyMDc0MjA4WjAjBgkqhkiG9w0BCQQxFgQUJ7bWRy068Fee8GPPOZ5MjRKS
# PsIwDQYJKoZIhvcNAQEBBQAEggEAVVCIuAWux+q9XxQOCoq8yQPXDwjLnxyXL1KF
# bJzpxi/A+MZLHKDy1OTf/ZPIeEZj3MAQM1JY2oJcRZm0wzZsPghk020nb3uG84Xa
# CJIxEB7jUOyMxYp1xq8FRrsfL//LFfx6iBo9gn9B4VEohtiy4/XjFzGlUxDZUG7M
# MjAwY7PufsaFtz4G1WCpSMN5jwpuAwJ1tD5Tk3cGR8iSXn6JY4jve03BT4VhjFhb
# m6qPaZ6sdfAtLwq1OFpGeztQJcNBqvBUUAwTVBqP5wclm6VdqnX58dV2mu7JuHfn
# O7V3QqfRHT28rEflmD0bdcTZPDDNdD5+Wll5f4HdLNyx/fHnjg==
