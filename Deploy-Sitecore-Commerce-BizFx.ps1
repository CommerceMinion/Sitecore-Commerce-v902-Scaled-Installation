...
$params = @{
        Path = Resolve-Path '.\Configuration\Commerce\Master_BizFx.json'	
		SiteName = $SiteName
		SiteHostHeaderName = $SiteHostHeaderName
		CertificateName = $SiteName				
		SitecoreBizFxServicesContentPath = Resolve-Path -Path "$ResourceRoot\Sitecore.BizFX.1.2.19"		
		...
		SitecoreIdentityServerName = "xp902-id"
		CommerceAuthoringService = $CommerceAuthoringService
