#Requires -Version 3
param(
    [string]$SiteName = "xp902-cm",	
	[string]$SiteHostHeaderName = "sxa.sitecore.com"
)
...
$SiteRootUrl = concat('http://', $SiteHostHeaderName)
$ProjectConfigIncludeDir = concat('C:\inetpub\wwwroot\xp902-cm', '\App_Config\Include\Project\Commerce')

$params = @{
		Path = Resolve-Path '.\Configuration\Commerce\SXAStorefront\SXAStorefront.CreateDefaultTenantAndSite.json'  
		SiteName = $SiteName
        ...
        ProjectConfigIncludeDir = $ProjectConfigIncludeDir
    }
