...
$global:ResourceRoot = "C:\Sitecore.Commerce.2018.07-2.2.126"  #This is where the XP1 wdps have been unzipped to
...
$global:SitecoreUsername = "sitecore\admin"
$global:SitecoreUserPassword = "b"

# User Account to use by default for all app pools
$global:UserAccount = @{
    Domain = $($Env:COMPUTERNAME)
    UserName = 'administrator'
    Password = 'Sitec0re123!'
}
...
# Commerce Services
$global:CommerceAuthoringService = "https://$Prefix-ce-auth"
$global:CommerceIdService = "https://$Prefix-id"
$global:CommerceBizFxService = "https://$Prefix-bizfx"
$global:CommerceShopsService = "https://$Prefix-ce-auth"
$global:CommerceOpsService = "https://$Prefix-ce-auth"
...
Write-Host "  UserAccount >>  $Domain\UserName" -ForegroundColor Gray ;
