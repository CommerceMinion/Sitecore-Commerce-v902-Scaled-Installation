...
$params = @{
        Path = Resolve-Path '.\Configuration\Commerce\Master_SitecorePackagesCD.json'	
		SiteName = $SiteName
		...
		AzureSearchAdminKey = ""
		AzureSearchQueryKey = ""
		CommerceEngineDacPac = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore.Commerce.Engine.SDK.2.1.10\Sitecore.Commerce.Engine.DB.dacpac"	   
		...
		SitecoreCommerceEngineZipPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore.Commerce.Engine.2.1.55.zip"		
		SitecoreBizFxServicesContentPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore.BizFX.1.1.9"		
		SitecoreIdentityServerZipPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore.IdentityServer.1.1.3.zip"
		CommerceEngineCertificatePath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\SIF.Sitecore.Commerce.1.1.4\storefront.engine.cer"		
        SiteUtilitiesSrc = ( Join-Path -Path $DEPLOYMENT_DIRECTORY -ChildPath "SiteUtilityPages" )	
        HabitatImagesModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore.Commerce.Habitat.Images-1.0.0.zip"	
        AdvImagesModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Adventure Works Images.zip"	
        CommerceConnectModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore Commerce Connect Core 11.1.78.zip"	
        CEConnectPackageFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore.Commerce.Engine.Connect.2.1.54.update"
        PowerShellExtensionsModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore PowerShell Extensions-4.7 for Sitecore 8.zip"
        SXAModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore Experience Accelerator 1.6 rev. 180103 for 9.0.zip"
        SXACommerceModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore Commerce Experience Accelerator 1.1.47.zip"
		SXAStorefrontModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore Commerce Experience Accelerator Storefront 1.1.47.zip"
        SXAStorefrontThemeModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore Commerce Experience Accelerator Storefront Themes 1.1.47.zip"
		SXAStorefrontCatalogModuleFullPath = Resolve-Path -Path "c:\deploy_xc\Sitecore.Commerce.2018.07-2.2.126\Sitecore Commerce Experience Accelerator Habitat Catalog 1.1.47.zip"
